...
import { getAuth, createUserWithEmailAndPassword ,signInWithEmailAndPassword , sendSignInLinkToEmail} from "https://www.gstatic.com/firebasejs/9.17.1/firebase-auth.js";
...
const firebaseConfig = {
  ...
  .then((userCredential) => {
    ...
    location.replace("/movie/index.html");
  })
  .catch((error) => {
